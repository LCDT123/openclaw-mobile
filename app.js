...
(function() {
    ...
    function setupKeyboardHandling() {
        ...
        if (window.visualViewport) {
            ...
            window.visualViewport.addEventListener('resize', () => {
                ...
                pendingUpdate = requestAnimationFrame(() => {
                    handleViewportChange(inputArea, messagesContainer);
                });
            });
        ...
        // Fallback: handle focus events on input
    ...
    function handleViewportChange(inputArea, messagesContainer) {
        ...
        if (keyboardHeight > 100) {
            ...
            messagesContainer.style.paddingBottom = `${keyboardHeight + 80}px`;
        } else {
            // Keyboard is hidden
            document.body.classList.remove('keyboard-visible');
            inputArea.style.transform = '';
    ...
    function setupEventListeners() {
        ...
        elements.settingsBtn.addEventListener('click', (e) => {
            e.preventDefault();
            e.stopPropagation();
            // Reset reconnect attempts when user opens settings
            state.reconnectAttempts = 0;
        ...
        elements.saveSettings.addEventListener('click', () => {
            ...
            state.reconnectAttempts = 0; // Reset on manual reconnect
            disconnect();
